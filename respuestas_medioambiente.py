respuestas_medioambiente = {
    ...
    'basura': "🗑️ *Abandonar basura o bienes muebles en vía pública.*\n(ejemplo: muebles, colchones, cocina, etc.)\n**Ordenanza 37 Medio Ambiente – Art. 39°**",

    'lavado': "🚿 *Realizar lavado de vehículos, bienes, elementos u otros en la vía pública.*\n**Ordenanza 37 Medio Ambiente – Art. 44°**",

    'agua': "💧 *Escurrir agua (potable, servidas, grises) hacia el bien nacional de uso público.*\n**Ordenanza 37 Medio Ambiente – Art. 44°**",

    'calefaccion': "🔥 *Mantener encendido chimeneas, braseros o calefactores a leña durante episodios de emergencia o preemergencia ambiental.*\n**Ordenanza 37 Medio Ambiente – Art. 50°**",

    'ruidos': "🔊 *Generar ruidos molestos (música a alto volumen, uso de maquinarias o parlantes) que afecten la convivencia vecinal.*\n**Ordenanza 37 Medio Ambiente – Art. 60°**"
}
