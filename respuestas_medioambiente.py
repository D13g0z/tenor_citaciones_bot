respuestas_medioambiente = {
   ...
   "residuospeligrosos": (
        "☣️ *Ordenanza N°37, Artículo 37*\n"
        "Depositar residuos peligrosos, tóxicos, contaminantes, corrosivos y/o cortantes en recipientes no adecuados.\n"
        "(indicar tipo de residuo)"
    ),
    "basura": (
        "🗑️ *Ordenanza N°37, Artículo 39*\n"
        "Abandonar basura o bienes muebles en vía pública.\n"
        "(ejemplo: muebles, colchones, cocina, etc.)"
    ),
    "lavado": (
        "🚿 *Ordenanza N°37, Artículo 44*\n"
        "Realizar lavado de vehículos, bienes, elementos u otros en la vía pública."
    ),
    "agua": (
        "💧 *Ordenanza N°37, Artículo 44*\n"
        "Escurrir agua (potable, servidas, grises) hacia el bien nacional de uso público."
    ),
    "calefaccion": (
        "🔥 *Ordenanza N°37, Artículo 50*\n"
        "Mantener encendido chimeneas, braseros o calefactores a leña durante episodios de emergencia o preemergencia ambiental."
    ),
    "ruidos": (
        "🔊 *Ordenanza N°37, Artículo 60*\n"
        "Generar ruidos molestos (música a alto volumen, uso de maquinarias o parlantes) que afecten la convivencia vecinal."
    )
